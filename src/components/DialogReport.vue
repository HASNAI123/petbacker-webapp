      ...
      <q-card style="overflow: visible; border-radius: 11px;">
        <q-card-section style="min-height: 150px;min-width: 250px;max-width: 280px;" class="q-px-none q-py-sm">
          ...
          <div class="bg-white q-mt-lg">
              ...
              <q-input color="primary" autofocus type="text" class="q-px-md q-pb-md" v-model="reportText"></q-input>
              <div class='full-width q-px-md'>
                ...
                <q-btn class="full-width text-capitalize q-my-sm" color="primary" outline v-if="okButtonLabel" :label="cancelButtonLabel === null ? $t('close') : cancelButtonLabel" @click="onCancel"></q-btn>
              </div>
          </div>
        </q-card-section>
      </q-card>
...
export default {
  ...
  methods: {
    onOk () {
      this.$emit('on-ok', this.reportText)
      this.onClose()
    },
    onCancel () {
