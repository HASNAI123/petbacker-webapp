    ...
    >
        ...
        <q-card style="border-top-left-radius:11px;border-top-right-radius:11px;" v-if="count === 0" class="q-pb-lg" >
            <q-card-section class="q-pb-xs">
              ...
              <p class="text-grey-9" v-if="type === 'passport'">{{$t('required.by.law.to.ensure.secure')}}</p>
              <p class="text-grey-9" v-else-if="['training.cert', 'grooming.cert', 'vet.cert'].indexOf(type) === -1">{{$t('ensure.petbacker.is.secure')}}</p>
            </q-card-section>
