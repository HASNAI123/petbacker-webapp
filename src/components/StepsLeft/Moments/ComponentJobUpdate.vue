<template>
  ...
  <q-input type="textarea" rows="2" autogrow v-model="momentSummary" :placeholder="$t('moment.what.on.your.mind')" class="input q-input--textarea q-input--dense q-input--auto-height" borderless @keyup.enter="$refs.inputSummary.focus()" />
      ...
      <q-card-section class="row  q-pa-none" >
        ...
        <q-btn icon="fas fa-plus" outline style="width: 100px; height: 100px; color:#ddd;" class="col-xs-3 q-ma-sm" :loading="pictureUploading" @click="onImageSelection"/>
        <input type="file" disable @change="onFileChange" accept=".jpg,.jpeg,.png" ref="selectedFile" style="display: none;">
      </q-card-section>
<br><br>
      <!-- Tags Section -->
      <q-card-section class="absolute-bottom q-mb-xl q-pb-lg">
  ...
  <p class="font-normal q-my-none text-weight-bold" style=" white-space: nowrap;">Tag job</p>
...
<div @click="  triggerPrivacyModal()" style="display: flex; justify-content: space-between;">
    <p class="font-normal q-my-none text-weight-bold" >Visible to</p>
