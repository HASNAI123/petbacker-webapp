<template>
  <q-card class="justify-center" >
    <q-scroll-area class="fit">
      ...
      <!-- Moment Summary -->
      <q-card-section>
        <q-input type="textarea"  wrap rows="2"  autogrow v-model="momentSummary" :placeholder="$t('moment.what.on.your.mind')" class="input" borderless @keyup.enter="$refs.inputSummary.focus()"></q-input>
      </q-card-section>
      ...
      <q-card-section style="margin-top: 10px;" class="absolute-bottom q-mb-xl q-pb-lg">
...
export default {
  ...
  mounted () {
    ...
    this.readVideoFile()
    console.log('function was inititiated')
  ...
  methods: {
    ...
    onPrivacyLevelUpdate (value) {
      ...
      console.log('Privacy Level Received: ', this.privacyLevel)
    },
    onLoadStart () {
    ...
    postMoment (momentImages) {
      ...
      // }
        ...
        setTimeout(() => {
          /* this.$q.notify({message: 'Moment successfully posted!', type: 'positive', position: 'top'}) */
